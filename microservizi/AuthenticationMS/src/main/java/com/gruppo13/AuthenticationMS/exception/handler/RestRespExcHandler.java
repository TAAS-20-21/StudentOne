package com.gruppo13.AuthenticationMS.exception.handler;
...
@ControllerAdvice
public class RestRespExcHandler extends ResponseEntityExceptionHandler {

    public RestRespExcHandler() {
        super();
    }
