...
public class LocalUser extends User {
    ...
    private com.gruppo13.ChatMS.model.User user;
    ...
    public LocalUser(final String userID, String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final com.gruppo13.ChatMS.model.User user) {
    ...
    public com.gruppo13.ChatMS.model.User getUser() {
        return user;
    }
